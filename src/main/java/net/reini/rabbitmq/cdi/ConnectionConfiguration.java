...
/**
 * <p>
 * Configures the connection settings of the connection factory that is used by
 * the class annotated by this configuration. The content of this configuration
 * is evaluated by a {@link ConnectionConfigurator}.
 * </p>
 *
...
public @interface ConnectionConfiguration {
    ...
    /**
     * <p>
     * The profile name of this configuration. If a profile is specified, this
     * configuration is only used if the system property
     * {@link ConnectionConfiguration#PROFILE_PROPERTY} is set to the specified
     * value (e.g. test, staging, ...).
     * </p>
     * 
