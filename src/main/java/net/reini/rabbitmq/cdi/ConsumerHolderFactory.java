...
{
    public ConsumerHolder createConsumerHolder(EventConsumer consumer, String queue, boolean autoAck, ConnectionRepository connectionRepository, ConnectionConfiguration config, ExchangeDeclarationConfig exchangeDeclarationConfig, QueueDeclarationConfig queueDeclarationConfig)
    {
