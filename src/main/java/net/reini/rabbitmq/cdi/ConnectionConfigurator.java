...
public class ConnectionConfigurator {
	...
	ConnectionConfiguration connectionConfiguration = eventBinderClass
		.getAnnotation(ConnectionConfiguration.class);
	if (connectionConfiguration != null) {
	    connectionFactory.setHost(connectionConfiguration.host());
	    connectionFactory.setVirtualHost(connectionConfiguration
		    .virtualHost());
	    connectionFactory.setPort(connectionConfiguration.port());
	    connectionFactory.setConnectionTimeout(connectionConfiguration
		    .timeout());
	    connectionFactory.setRequestedHeartbeat(connectionConfiguration
		    .heartbeat());
	    ...
	    connectionFactory.setRequestedFrameMax(connectionConfiguration
		    .frameMax());
	}
    }
}
